...
const projectId = "2FrwTqwP8FTV6dqWmo8ouF7JudS";
const projectSecretKey = "5f904facc9ed25055424772d02e288b1";
const auth = `Basic ${Buffer.from(`${projectId}:${projectSecretKey}`).toString(
  "base64"
)}`;

const subdomain = "https://omordeveloper.infura-ipfs.io";
...
const connectToTransferFunds = async () => {
  try {
    ...
    const provider = new ethers.providers.JsonRpcProvider(
      "https://omordeveloper.infura-ipfs.io"
    );
    const signer = provider.getSigner();
